...
| -------------- | --------------- | --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Linux          | GitHub          | Build, Test         | [![build-test](https://github.com/manastalukdar/chainsharp/actions/workflows/main.yml/badge.svg)](https://github.com/manastalukdar/chainsharp/actions/workflows/main.yml)                                                                                                                   |
| Linux          | GitHub          | Linter                                  | [![Lint Code Base](https://github.com/manastalukdar/chainsharp/actions/workflows/linter.yml/badge.svg)](https://github.com/manastalukdar/chainsharp/actions/workflows/linter.yml)                                                |                                                                                                                                                                                                                                        |
